          ...
          <el-dropdown size="mini" @command="(command) => handleCommand(command, scope.row)" v-hasPermi="['monitor:job:changeStatus', 'monitor:job:query']">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item command="handleJobLog" icon="el-icon-s-operation"
                v-hasPermi="['monitor:job:query']">調度日誌</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </template>
      </el-table-column>
              ...
              <span slot="label">
                ...
                <el-tooltip placement="top">
                  <div slot="content">
                    ...
                    <br />參數說明：支持字符串，布爾類型，長整型，浮點型，整型
                  </div>
                  <i class="el-icon-question"></i>
                </el-tooltip>
              </span>
              <el-input v-model="form.invokeTarget" placeholder="請輸入調用目標字符串" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        invokeTarget: [
          { required: true, message: "調用目標字符串不能為空", trigger: "blur" }
        ],
        cronExpression: [
