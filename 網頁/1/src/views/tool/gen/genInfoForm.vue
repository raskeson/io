    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item prop="functionName">
          <span slot="label">
            生成功能名
            <el-tooltip content="用作類描述，例如 用戶" placement="top">
              <i class="el-icon-question"></i>
            </el-tooltip>
          </span>
      ...
      <el-col :span="24" v-if="info.genType == '1'">
        <el-form-item prop="genPath">
          <span slot="label">
            自定義路徑
            <el-tooltip content="填寫磁盤絕對路徑，若不填寫，則生成到當前Web項目下" placement="top">
              <i class="el-icon-question"></i>
            </el-tooltip>
          </span>
          <el-input v-model="info.genPath">
            <el-dropdown slot="append">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item @click.native="info.genPath = '/'">恢復默認的生成基礎路徑</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </el-input>
        </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        moduleName: [
          { required: true, message: "請輸入生成模塊名", trigger: "blur" }
        ],
        businessName: [
