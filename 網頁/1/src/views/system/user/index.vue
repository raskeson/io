  ...
  <div class="app-container">
      <!--用戶數據-->
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="用戶昵稱" align="center" key="nickName" prop="nickName" v-if="columns[2].visible" :show-overflow-tooltip="true" />
          <el-table-column label="手機號碼" align="center" key="phonenumber" prop="phonenumber" v-if="columns[3].visible" width="120" />
          <el-table-column label="狀態" align="center" key="status" v-if="columns[4].visible">
          ...
          <el-table-column label="創建時間" align="center" prop="createTime" v-if="columns[5].visible" width="160">
            <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="用戶昵稱" prop="nickName">
              <el-input v-model="form.nickName" placeholder="請輸入用戶昵稱" maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item v-if="form.userId == undefined" label="用戶賬號" prop="userName">
              <el-input v-model="form.userName" placeholder="請輸入用戶賬號" maxlength="30" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item v-if="form.userId == undefined" label="用戶密碼" prop="password">
              <el-input v-model="form.password" placeholder="請輸入用戶密碼" type="password" maxlength="20" show-password/>
            </el-form-item>
          </el-col>
            <el-col :span="12">
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: 3, label: `手機號碼`, visible: true },
        { key: 4, label: `狀態`, visible: true },
        { key: 5, label: `創建時間`, visible: true }
      ],
      // 表單校驗
      rules: {
        userName: [
          { required: true, message: "用戶名稱不能為空", trigger: "blur" },
          { min: 2, max: 20, message: '用戶名稱長度必須介於 2 和 20 之間', trigger: 'blur' }
        ],
        nickName: [
