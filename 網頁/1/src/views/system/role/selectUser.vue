<template>
  <!-- 授權用戶 -->
  <el-dialog title="選擇用戶" :visible.sync="visible" width="800px" top="5vh" append-to-body>
    ...
    <el-row>
      <el-table @row-click="clickRow" ref="table" :data="userList" @selection-change="handleSelectionChange" height="260px">
        ...
        <el-table-column label="用戶名稱" prop="userName" :show-overflow-tooltip="true" />
        <el-table-column label="用戶昵稱" prop="nickName" :show-overflow-tooltip="true" />
