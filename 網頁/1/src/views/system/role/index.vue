<template>
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item prop="roleKey">
          <span slot="label">
            <el-tooltip
              content="控製器中定義的權限字符，如：@PreAuthorize(`@ss.hasRole('admin')`)"
              placement="top"
            >
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitApiResource">確 定</el-button>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm('是否確認刪除角色編號為"' + roleIds + '"的數據項？')
        .then(function () {
