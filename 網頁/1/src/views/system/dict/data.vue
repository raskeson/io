<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="字典標簽" prop="dictLabel">
        <el-input
      ...
      <el-form-item label="狀態" prop="status">
        <el-select v-model="queryParams.status" placeholder="數據狀態" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="字典標簽" align="center" prop="dictLabel">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="數據標簽" prop="dictLabel">
          <el-input v-model="form.dictLabel" placeholder="請輸入數據標簽" />
        </el-form-item>
