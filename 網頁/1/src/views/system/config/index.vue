  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="系統內置" prop="configType">
        <el-select v-model="queryParams.configType" placeholder="系統內置" clearable>
          <el-option
      ...
      <el-form-item label="參數分組" prop="configType">
        <el-select v-model="queryParams.groupCode" placeholder="參數分組"  clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="系統內置" align="center" prop="configType">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_yes_no" :value="scope.row.configType"/>
        </template>
      </el-table-column>
      <el-table-column label="備註" align="center" prop="remark" :show-overflow-tooltip="true" />
      <el-table-column label="分組" align="center" prop="groupCode" >
        <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
           <el-form-item label="參數分組" prop="groupCode">
            <el-select v-model="form.groupCode" placeholder="參數分組" clearable>
                <el-option
                v-for="dict in dict.type.sys_config_group"
                :key="dict.value"
               :label="dict.label"
  ...
  data() {
    return {
      ...
      rules: {
        ...
        groupCode: [
           { required: true, message: "參數分組不能為空", trigger: "blur" }
        ]
      }
    };
  },
